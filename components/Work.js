		...
		<div className="mt-10">
			<div className="flex justify-center">
				<Image
					...
					height={47}
				/>
				<h1 className="text-white text-6xl font-bold mx-3">How we work?</h1>
				<Image
			...
			<section className="text-gray-600 body-font flex justify-between mt-24">
				...
				<Image
					src="/assets/images/Rectangle 6.jpg"
					alt="image"
					width={415}
					height={615}
				/>
